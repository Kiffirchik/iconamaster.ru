...
<?php if ($key === 'moreDetails'): ?><small>Обычный текст, без HTML. Переносы строк сохраняются. Показывается под описанием по нажатию «Подробнее об иконе». Оставьте пустым, чтобы скрыть кнопку.</small><?php endif; ?>
